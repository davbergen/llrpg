...
export const CLASS_ABILITIES: ClassAbility[] = [
  ...
  },
  {
    ...
    baseDamage: 30,
    effects: [],
    description: 'Hurls a ball of flame for pure, heavy damage — no frills.',
  ...
  },
  {
    ...
    baseDamage: 50,
    effects: [],
    description: 'Calls down a meteor — a big-Mana burst that ends fights in fewer turns.',
  ...
  },
  {
    ...
    mpCost: 4,
    baseDamage: 46,
    effects: [{ kind: 'counter_reduction', fraction: 0.2 }],
    description: 'Lightning that arcs through the enemy, disrupting its counterattack this turn.',
    lessonQuestions: lessonQuestionsForMp(4),
  },
  {
    id: 'mage_cataclysm',
  ...
  },
  {
    ...
    secondaryGain: 4,
    effects: [{ kind: 'counter_reduction', fraction: 0.2 }],
    description: 'A wide, controlled swing that also blunts the enemy’s counter this turn — less raw damage than Reckless Strike.',
    lessonQuestions: lessonQuestionsForMp(2),
  },
  {
    ...
    secondaryGain: 5,
    effects: [],
    description: 'An all-out blow — more damage than Cleave and builds heavy Rage, but leaves you open to the full counter.',
    lessonQuestions: lessonQuestionsForMp(2),
  },
  {
